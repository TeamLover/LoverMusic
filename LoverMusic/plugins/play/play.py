...
import config
from LoverMusic import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
...
from LoverMusic.utils.inline import (
    botplaylist_markup,
    livestream_markup,
    playlist_markup,
    slider_markup,
...
@app.on_callback_query(filters.regex("LoverPlaylists") & ~BANNED_USERS)
@languageCB
